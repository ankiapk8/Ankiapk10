...
const SUBJECTS = [
  { label: "ENT", storageKey: "ent", path: "/sub-surgery/ent" },
  { label: "Ophthalmology", storageKey: "ophthalmology", path: "/sub-surgery/ophthalmology" },
  { label: "Orthopedic", storageKey: "orthopedic", path: "/sub-surgery/orthopedic" },
  { label: "Neurosurgery", storageKey: "neurosurgery", path: "/sub-surgery/neurosurgery" },
  { label: "Urology", storageKey: "urology", path: "/sub-surgery/urology" },
];

export default function SubSurgery() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-base font-semibold">Sub Surgery</h1>
      </div>
