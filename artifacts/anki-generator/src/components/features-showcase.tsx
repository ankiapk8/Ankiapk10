...
const FEATURE_PREVIEWS = [
  ...
  PreviewMindMapExport, PreviewFeedback, PreviewProdromes,
];
...
const FEATURES = [
  ...
  { icon: Activity, color: "#f87171", glow: "hsl(0 91% 71% / 0.5)", label: "Prodrome Study", desc: "Master early warning signs before disease onset. AI generates prodrome flashcards with mnemonics — high-yield for USMLE, MCCQE, and licensing exams.", accent: "from-red-400 to-rose-500", bgDark: "from-red-500/10 via-rose-500/5 to-transparent", bgLight: "from-red-500/8 via-rose-500/4 to-transparent" },
];
