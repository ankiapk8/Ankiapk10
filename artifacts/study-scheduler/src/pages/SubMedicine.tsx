...
const SUB_MEDICINE_KEYS = ["dermatology", "family", "emergency", "forensic", "radiology"];

export function SubMedicine() {
  ...
  const subjects = ALL_SUBJECT_GROUPS.filter((g) => SUB_MEDICINE_KEYS.includes(g.storageKey));
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold text-foreground">Sub Medicine</h1>
          </div>
        </div>
        ...
        <div className="grid gap-3">
          {subjects.map((g) => {
            ...
            return (
              <Link key={g.storageKey} href={`/sub-medicine/${g.storageKey}`}>
                <div
