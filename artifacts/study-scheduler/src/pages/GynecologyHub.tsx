...
const GYNECOLOGY_KEYS = ["gynecology", "obstetric"];

export function GynecologyHub() {
  ...
  const subjects = ALL_SUBJECT_GROUPS.filter((g) => GYNECOLOGY_KEYS.includes(g.storageKey));
      ...
      <div className="max-w-2xl mx-auto px-4 py-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold text-foreground">Gynecology</h1>
          </div>
        </div>
        ...
        <div className="grid gap-3">
          {subjects.map((g) => {
            ...
            return (
              <Link key={g.storageKey} href={`/gynecology/${g.storageKey}`}>
                <div
